...
//        assertEquals(70000.0, actualProduct.getPrice());
    ...
    public void testGetSingleProductThrowsProductNotFoundException() throws ProductNotFoundException {
        ProductNotFoundException productNotFoundException = new ProductNotFoundException("Please pass the correct product ID");
    ...
    public void testGetSingleProduct_NegativeCase() {
